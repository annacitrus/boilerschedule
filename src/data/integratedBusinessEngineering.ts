...
const integratedBusinessEngineering: MajorData = {
  courses: {
    ...
    CHM11520: { name: "General Chemistry I Laboratory (or 11530)", credits: 1 },
    ...
    IBE29150: { name: "IBE Professional Development", credits: 0 },
    ...
    MIS38800: { name: "Python For Business", credits: 3, prereqs: ["ENGR13300"]},
    ...
    // Fall 3rd Year
    SCOM36100: { name: "Operations Management", credits: 3, prereqs: ["STAT35000", "MA16600", "MA16500"] },
  ...
  semesters: [
    {
      label: "Fall 1st Year",
      courses: ["ENGR13300", "ACCT20000", "IBE29110", "CHM11510", "CHM11520", "MA16500", "EPICS/VIP I"],
    },
    {
    ...
    {
      label: "Fall 2nd Year",
      courses: ["ACCT20100", "IBE29120", "IBE29150", "MA26100", "STAT35000", "Written Communication Selective", "Engineering IBE Core I"],
    },
    {
      label: "Spring 2nd Year",
      courses: ["FIN31000", "IBE29130", "IBE29150", "MIS38800", "MKTG32400", "QM30500", "Engineering IBE Core II"],
    },
    {
      label: "Fall 3rd Year",
      courses: ["IBE29150", "SCOM36100", "STRT49200", "Business Method Selective I", "Specialties Course I", "Team Based Design Selective I"],
    },
    {
      label: "Spring 3rd Year",
      courses: ["IBE29150", "MIS38200", "Business Method Selective II", "Engineering Expansion Course", "Engineering Selective", "Team Based Design Selective II"],
    },
    {
      label: "Fall 4th Year",
