...
function App() {
  const courses: Record<string, CourseInfo> = {
    ...
    PSY200: { name: "Intro to Cognitive Psychology (or PSY 222)", credits: 3, prereqs: ["PSY120"] },
    CS243: { name: "Artificial Intelligence Basics", credits: 3, prereqs: ["CS180", "CS182", "MA161"]
    },
    MA261: {
    ...
    STAT350: { name: "Statistics (or STAT 511)", credits: 3, prereqs: ["MA162", "MA161"] },
    PHIL207: { name: "Ethics (or PHIL 208)", credits: 3 },
    "Science Core Selection": { name: "", credits: 3 },
    CS253: { name: "Data Structures and Algorithms for DS/AI", credits: 3, prereqs: ["CS176", "CS180","CS182", "MA161"] },
    MA265: {
      name: "Linear Algebra (or MA 351)",
      credits: 3,
      prereqs: ["MA161", "MA162"],
    },
    MA416: { name: "Probability (or STAT 416)", credits: 3, prereqs: ["MA162", "MA161", "MA261"] },
    PHIL221: {
      name: "Introduction To Philosophy of Science (or PHIL 322)",
      credits: 3,
    },
    CS373: { name: "Data Mining And Machine Learning", credits: 3, prereqs: ["CS182", "CS180", "CS253", "STAT350"] },
    CS381: { name: "Introduction To The Analysis Of Algorithms", credits: 3, prereqs:["CS253", "CS180", "CS182", "MA161","MA 162", "MA261" ]},
    CS471: { name: "Introduction To Artificial Intelligence", credits: 3, prereqs: ["CS176", "CS180","CS182", "MA161", "CS253"] },
